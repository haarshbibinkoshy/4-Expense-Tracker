...
let rental=food=electricity=grocery=medical=travel=salary=0
...
function drawChart() {
  let data = google.visualization.arrayToDataTable(
    [
      ['expense', 'amount'],
     [`rental`,rental],['travel',travel],[`food`,food],[`electricity`,electricity],[`grocery`,grocery],[`medical`,medical],[`salary`,salary]
    ]
    );
